...
<html lang="ja">
    <head>
    <meta charset="utf-8">
     <link rel="stylesheet" type="text/css" href="CCP_プロジェクト詳細.css">
    <title>プロジェクトの詳細</title>
    <!--データベースに接続-->
    <?php
    $db_user='xs449197_katsu';
    $db_password='LQYNaZF2dxQz';
    $pdo = new PDO('mysql:host=localhost;dbname=xs449197_katsu;charset=utf8',$db_user,$db_password);
        ?>
    </head>
    <body>
        <div>
    ...
    　　</div>
        <div class="flex"><!画像は暫定的に貼ってるだけ>
            ...
            <a href="#slide-4">4</a>
            <a href="#slide-5">5</a>
            <div class="slides" style="align:left">
        ...
        <div>
            <div class="box">
                ...
                <h2>みんなのコメント</h2><br>
                <!コメント入力欄>
                <form method="post" action="CCP_コメント管理.html">
                    <p>ニックネーム：<br>
        ...
        if (isset($_REQUEST['name']) && !empty($_REQUEST['name'])) {
            ...
            $comment = htmlspecialchars($_REQUEST['name']);//SQLインジェクション対応済み？
            $time = date("Y/m/d H:i:s");
            $spl = (
            'INSERT INTO
            'CCP_comments'(xs449197_katsu, xs449197_katsu, LQYNaZF2dxQz)
            VALUES(:xs449197_katsu, :xs449197_katsu, :LQYNaZF2dxQz)');
        }
